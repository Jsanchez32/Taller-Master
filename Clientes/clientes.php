        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                  <a class="btn btn-danger" href="borrar.php?clienteId=<?=$val['clienteId']?>&req=delete">Borrar</a>
                  <a class="btn btn-warning" href="actualizar.php?clienteId=<?=$val['clienteId']?>">Actualizar</a>
              </td>
            </tr>
            <?php }; ?>
          </tbody>
