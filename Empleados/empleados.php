        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                  <a class="btn btn-danger" href="borrar.php?empleadoId=<?=$val['empleadoId']?>&req=delete">Borrar</a>
                  <a class="btn btn-warning" href="actualizar.php?empleadoId=<?=$val['empleadoId']?>">Actualizar</a>
              </td>
            </tr>
            <?php }; ?>
          </tbody>
        ...
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrar.php" method="post">
              ...
              <div class="mb-1 col-12">
                <label for="direccion" class="form-label">Celular</label>
                <input 
                  type="text"
                  id="celular"
                  name="celular"
