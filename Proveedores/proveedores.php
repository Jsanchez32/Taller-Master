        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                  <a class="btn btn-danger" href="borrar.php?proveedorId=<?=$val['proveedorId']?>&req=delete">Borrar</a>
                  <a class="btn btn-warning" href="actualizar.php?proveedorId=<?=$val['proveedorId']?>">Actualizar</a>
              </td>
            </tr>
            <?php }; ?>
          </tbody>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
        <div class="modal-content" >
          <div class="modal-header" >
            <h1 class="modal-title fs-5" id="exampleModalLabel">Nueva Proveedor</h1>
